function NoteList({ notes, onRemoveNote }) {
  return (
    <div className=" basis-[50%] bg-slate-30   w-full  my-3  " >
      ...
      <div className="  bg-black/ px-3 w-full h-auto flex items-center justify-start  flex-col mt-6 max-h-[480px] overflow-y-auto overflow-x-hidden/ " >
        {
...
function NoteItem({ note, onRemoveNote }) {
  ...
  return (
    <div className="  w-full  my-2 bg-white rounded-2xl shadow-sm ">
      <div className=" flex items-center justify-between w-full " >
        ...
        <div className=" flex items-center justify-evenly basis-[15%]  ">
          ...
          <svg onClick={() => onRemoveNote(note.id)} className=" cursor-pointer size-8 stroke-red-600 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
