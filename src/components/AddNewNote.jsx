...
function AddNewNote({ onAddNote }) {
    ...
    return (
        <div className="my-3 xx:basis-1/3 mm:w-2/3 mm:max-w-96 ss:w-[80%] xl:mt-12 xg:mt-16 xx:mt-16 mm:mt-14 ss:mt-16 w-full  ">
            <h1 className=" text-center text-zinc-700 2xl:text-[27px] xl:text-[25px] xg:text-[24px] xx:text-[23px] mm:text-[24px] ss:text-[22px] font-semibold "  >Add New Note </h1>
